$().ready(function(){
    ...
    $("#btn_syday").click(function(){
        var firstDate=new Date(2017,12,1);
        var endDate = new Date();
        refresh(firstDate, endDate);
    });

    $("#btn_lastWeekday").click(function(){
        var firstDate = getLastWeekStartDate();
        var endDate = getLastWeekEndDate();
        refresh(firstDate, endDate);
    });

    $("#btn_bigyesterday").click(function(){
        var date=new Date();
    ...
    $("#btn_lastMonthday").click(function(){
        var firstDate = getLastMonthStartDate();
        var endDate = getLastMonthEndDate();
        refresh(firstDate, endDate);
    });

    $("#btn_onday").click(function(){
        var date = $("#pick-date-end").val()
