...
var firstDate=new Date();
    ...
    $('#btn_search').click(function(){ //查询
        ...
        var historyUrl = String.format("/admin/statistics/new/member?islist=1&pageSize=10&pageNumber=1&sortOrder=asc&startDate={0}&endDate={1}&userid={2}&ag={3}&clubid={4}&roomid={5}&gameid={6}&cards={7}&roomkey={8}&account={9}&gamename={10}", startDate, endDate, userid, ag,clubid,roomid,gameid,cards,roomkey,account,gamename)
