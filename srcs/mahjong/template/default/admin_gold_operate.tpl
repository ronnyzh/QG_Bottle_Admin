...
<script type="text/javascript">
    ...
    $('#classic').click(function(){
        window.location.href = '/admin/gold/operate?niuniu_type=1'
    });

    $('#open_hand').click(function(){
        window.location.href = '/admin/gold/operate?niuniu_type=2'
    });

    $('#joy').click(function(){
        window.location.href = '/admin/gold/operate?niuniu_type=3'
    });
...
function fresh_table(niuniu_type){
    ...
    }else if(niuniu_type==2){
        bootstrap_dic['url'] = '{{info["listUrl"]}}'
    }else if(niuniu_type==3){
        bootstrap_dic['url'] = '{{info["listUrl"]}}'
    }
...
function initTable(){
    if('{{info["niuniu_type"]}}'=='1'){
        fresh_table(1)
    }else if('{{info["niuniu_type"]}}'=='2'){
        fresh_table(2)
    }else{
        fresh_table(3)
    }
