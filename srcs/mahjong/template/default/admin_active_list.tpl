...
<script type="text/javascript">
    ...
    $('#dataTable').bootstrapTable({
        ...
        function getFunImg(value,row,index){
              eval('var rowobj='+JSON.stringify(row))
              statusstr = '<img src="'+value+'" width="100" height="100" />';
        ...
        function getOp(value,row,index){
              var showComfirUrl = [
                    '/admin/notice/active/push/HALL',
                    '/admin/notice/active/push/FISH',
                    '/admin/notice/active/del',
              ];
