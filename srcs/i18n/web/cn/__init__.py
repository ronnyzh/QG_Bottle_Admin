...
MENU_GAME_CONFIGURATION = '金币场场次列表'
...
MENU_AGENT_TXT = '代理管理'
MENU_AGENT_LIST_TXT = '下线代理列表'
MENU_AGENT_ACTIVE_TXT = '代理活跃统计'
MENU_AGENT_BINDING_TXT = '代理绑定账号'
MENU_AGENT_ROOM_LIST_TXT = '玩家房间列表'
MENU_AGENT_CHILD_ROOM_LIST_TXT = "玩家房间列表"
MENU_AGENT_CLUBLIST_TXT = '亲友圈列表'
MENU_MEMBER_TXT = '会员管理'
MENU_AGENT_MEMBER_CURONLINE_TXT = '会员在线'
MENU_AGENT_MEMBER_DAYUSE_TXT = '会员日消耗'
...
MENU_ORDER_WECHAT_SALE_CURRENCY_TXT = '商城售币记录'
...
MENU_STATISTICS_GRAPHS_TXT = '图表统计'
MENU_STATISTICS_REG_TXT = '注册人数统计'
MENU_STATISTICS_LOGIN_TXT = '登录人数统计'
MENU_STATISTICS_ACTIVE_TXT = '活跃人数统计'
MENU_STATISTICS_CLUB_CHANGE_TXT = '亲友圈数据统计'
MENU_STATISTICS_ROOMCARD_TXT = '游戏耗钻数统计'
MENU_STATISTICS_CLUB_TXT = '亲友圈耗钻数统计'
...
MENU_STATISTICS_ACTIVE_HISTORY_TXT = '活跃人数统计历史'
MENU_STATISTICS_ACTIVE_HISTORY2_TXT = '活跃人数统计历史(新)'
...
WECHAT_SALE_CURRENCY_TITLE = '商城售币记录'
WECHAT_FISH_RECORD_TITLE = '捕鱼微信金币充值记录'
# 列表权限
LIST_AGENT_CLUB_TXT = '亲友圈'
LIST_AGENT_MODIFY_PASSWD_TXT = '重置密码'
...
GOLD_LOG_DATA = "金币流水表"
GOLD_AMOUNT = "机器人表"
GOLD_ROOMCOST = "金币场房费表"
GOLD_TRANS_ORDER = "金币场局数表"
GOLD_GAME_DAY_DATA = '每日游戏人数统计表'
GOLD_FIELD_RANKING = '每日金币排行'
